...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=voetbalavtjs.database.windows.net;Database=VoetbalSQL;User Id=voetbalavtjs;Password=azerty-123;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Stadion>(entity =>
            {
                ...
                entity.Property(e => e.Basisprijs).HasColumnType("numeric(18, 0)");
