    ...
    public class StadionController : Controller
    {
        ...
        public IActionResult Info()
        {
            var stadions = new List<StadionInfoVM> //generieke lijst
            {
                ...
                new StadionInfoVM {Naam = "Constant Vanden Stock stadion" , Omschrijving = "Het Constant Vanden Stock stadion is een voetbalstadion in de Belgische gemeente Anderlecht, in het Brussels Hoofdstedelijk Gewest. Het is de thuisbasis van voetbalclub RSC Anderlecht. Het stadion bevindt zich in het Astridpark.",
